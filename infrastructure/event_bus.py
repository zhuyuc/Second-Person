...
# 追问式补充信息模块（elicitation §事件总线）
EVT_ELICITATION_TRIGGERED = "elicitation.triggered"
EVT_ELICITATION_ANSWERED = "elicitation.answered"
EVT_ELICITATION_RESOLVED = "elicitation.resolved"
EVT_ELICITATION_CLOSED = "elicitation.closed"
EVT_ELICITATION_EXPIRED = "elicitation.expired"
