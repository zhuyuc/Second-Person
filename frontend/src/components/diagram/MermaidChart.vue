...
import { loadMermaid, applyMermaidTheme } from '@/utils/mermaidLoader'
...
function onWheel(e) {
  ...
  view.zoomAt(e.clientX - rect.left, e.clientY - rect.top, e.deltaY > 0 ? 1 / view.step : view.step)
}
...
<template>
  <div ref="container" class="mc-wrap">
    ...
    <div class="fc-actions">
      ...
      <button class="fc-btn" title="查看源码" @click="toggleSource">
        <i class="ti ti-code"></i> 查看源码
      </button>
      <button class="fc-btn" title="复制图片" @click="copyImage">
        <i class="ti ti-copy"></i> 图片
      </button>
    ...
    <div v-if="showSrc" class="mc-src">
      <div class="mc-src-head">
        ...
        <button class="fc-btn" title="复制源码" @click="copySrc">
