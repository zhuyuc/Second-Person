...
// handoff 摘要状态
const HANDOFF_MAP = { generating: '生成中', ready: '已就绪', failed: '生成失败' }
// 会话状态保留位：当前无多状态展示需求，预留未来扩展
// 时间线事件类型
export const EVT_MAP = {
  created: '新建',
  updated: '更新',
  evolved: '演变',
  imported: '导入',
...
// SOUL 风格来源保留位：画像来源当前以 UI 文案直出
// 健康度扣分维度
export const DEDUCT_MAP = {
  disputed: '矛盾记忆',
  low_unconfirmed: '低置信未确认',
  stale: '过期记忆',
  orphan: '孤立记忆',
  duplicate: '疑似重复',
  missing: 'md 文件缺失',
...
const SOURCE_NAMES = {
  ...
  title_gen: '标题生成',
  vision: '图片解析',
  image_gen: '文生图（本地 ComfyUI）',
  image_prompt_refine: '生图提示润色',
  video_gen: '文生视频（本地 ComfyUI）',
  video_prompt_refine: '生视频提示润色',
  tool_infer: '工具推断',
  handoff_summary: '交接摘要生成',
